 ...
 */
function _sumfields_civix_civicrm_themes(&$themes) {
  $files = _sumfields_civix_glob(__DIR__ . '/*.theme.php');
  foreach ($files as $file) {
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _sumfields_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
 ...
 */
function _sumfields_civix_civicrm_entityTypes(&$entityTypes) {
